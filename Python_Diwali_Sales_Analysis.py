...
#import csv file
df = pd.read_csv(r"F:\\A DATA SCIENCE 2023\\Database Meet Sir 2023\\Projects\\Python Diwali Sales Analysis\\Diwali Sales Data.csv", 
...
# complete project on Github: https://github.com/Vyas-Rishabh/Python_Diwali_Sales_Analysis
